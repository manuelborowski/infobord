...
default_configuration_settings = {
    ...
    'smartschool-message-title-lesson-swap-at-home': ('', Settings.SETTING_TYPE.E_STRING),
    'smartschool-message-body-lesson-swap-at-home': ('', Settings.SETTING_TYPE.E_STRING),
    'smartschool-message-title-lesson-swap-to-home': ('', Settings.SETTING_TYPE.E_STRING),
    'smartschool-message-body-lesson-swap-to-home': ('', Settings.SETTING_TYPE.E_STRING),
